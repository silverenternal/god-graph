...
fn main() {
    ...
    println!("   Created KV Cache with capacity: {} tokens", kv_cache.max_seq_len());
    ...
    println!("   Padded input shape: [{} x {}]", 
             batch.batch_size(), batch.max_seq_len());

    println!("\n=== Feature Overview Complete ===");
    println!("\nFor detailed examples, run:");
    println!("  cargo run --example transformer_advanced --features transformer,safetensors,tensor-pool");
}
