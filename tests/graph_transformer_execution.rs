...
mod tests {
    ...
    fn test_graph_transformer_to_dot() {
        ...
        assert!(dot.contains("TokenEmbed") || dot.contains("Hidden") || 
                dot.contains("Attn") || dot.contains("FFN"));
    }
    ...
    fn test_self_attention_edge_with_qkv() {
        ...
        let edge = GraphEdge::self_attention_with_qkv(
            0, 1, 0.8, 2, 0, q_proj, k_proj, v_proj,
        );
    ...
    fn test_self_attention_edge_attention_score() {
        ...
        let edge = GraphEdge::self_attention_with_qkv(
            0, 1, 0.8, 0, 0, q_proj, k_proj, v_proj,
        );
    ...
    fn test_data_flow_edge_with_message() {
        ...
        let edge = GraphEdge::data_flow_with_message(
            0, 1, DataFlowOp::AttentionToOutput, 0, activation,
        );
    ...
    fn test_residual_edge_with_tensor() {
        ...
        let edge = GraphEdge::residual_with_tensor(
            0, 1, 0, SkipType::PostNorm, residual,
        );
    ...
    fn test_tensor_message_passing_workflow() {
        ...
        let mut edge = GraphEdge::self_attention_with_qkv(
            0, 1, 0.8, 0, 0, q_proj, k_proj, v_proj,
        );
    ...
    fn test_forward_numerical_stability() {
        ...
        let max_val = output.data().iter().fold(f64::NEG_INFINITY, |a, &b| a.max(b));
